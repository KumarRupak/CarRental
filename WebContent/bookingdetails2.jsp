...
<div class="container register">
			  ...
			  ResultSet rs=st.executeQuery("select * from bookcab where driverid='"+uname+"'");
			  while(rs.next())
			  {
				  out.print("<tr><td>");
			  ...
			  %>
                   ...
                   <input type="submit"  name="cancel" value="cancel Bookikg">
                    <input type="submit"  name="cancel" value="Update Bookikg">
                   </div>
                   </div>
                   </form>
</body>
